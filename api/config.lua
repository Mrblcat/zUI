...
zUI:UpdateConfig( "castbar", "player", "hide_blizz", "1")
zUI:UpdateConfig( "castbar", "player", "hide_zUI", "0")
zUI:UpdateConfig( "castbar", "target", "hide_zUI", "0")
zUI:UpdateConfig( "castbar", nil, "flat_texture", "0")
...
zUI:UpdateConfig( "nameplates", nil, "overlap", "1")
...
zUI:UpdateConfig( "quality", nil, "clean_up", "1")
...
zUI:UpdateConfig( "unitframes", nil, "namefontsize", "13")
zUI:UpdateConfig( "unitframes", nil, "valuefontsize", "13")
