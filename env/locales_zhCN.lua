  ...
  zUI.mlocals = {
    ["Your vendor trash has been sold and you earned "] = "出售垃圾：",
    ["Sell Grey Items"] = "出售垃圾",
    [" Gold"] = " 金",
    [" Silver"] = " 银",
    [" Copper"] = " 铜",
    ["0 Copper"] = "0 铜",
    ["Your repair bill for work done to your equipment was: "] = "修理花费: ",
    ["Thank's for using zUI, type /zui for options frame."] = "加载成功！",
    ["Channeling"] = "正在引导",
    ["Classic Snowfall ALT SelfCast now disabled."] = " ALT键自我施法关闭",
    ["Classic Snowfall ALT SelfCast now enabled."] = "ALT键自我施法开启",
    ["Sell"] = "卖价",
    ["Buy"] = "买价",
    ["About"] = "关于",
    ["General"] = "基础设置",
    ["Auto Hide Micro Menu"] = "自动隐藏微型菜单和背包",
    ["Show Endcaps (Gryphons)"] = "显示隐藏（动作条狮鹫）",
    ["Enable Global Dark Mode"] = "启用全局黑暗模式",
    ["Quality of Life"] = "常用设置",
    ["Auto Dismount"] = "自动下马",
    ["Auto Stance-Switch"] = "自动站立",
    ["Retarget Feign Death"] = "假死重置目标",
    ["Swingtimer"] = "攻击计时条",
    ["Hide Swingtimer"] = "关闭攻击计时条",
    ["Swingtimer for all classes"] = "全职业启用攻击计时条",
    ["Swingtimer Color"] = "计时条颜色",
    ["Actionbars"] = "动作条",
    ["Enable BFA-Style"] = "启用BFA样式",
    ["Enable Square Style"] = "启用方形样式",
    ["Hotkey Text Color"] = "热键文本颜色",
    ["Use Blizzard Hotkey Font"] = "使用暴雪热键字体",
    ["Action Button Border Color"] = "动作按钮边框颜色",
    ["Unitframes"] = "单位框架",
    ["Compact Unitframes"] = "紧凑型",
    ["Class Portraits"] = "职业头像",
    ["Show Status Glow Effect"] = "状态流光",
    ["Improved Pet Frame"] = "精简宠物框架",
    ["Text"] = "文本样式",
    ["Force Show Hp/Mp (Ignore 'Status Bar Text' Interface Option)"] = "强制显示 HP/MP",
    ["Show Percentage"] = "百分比样式",
    ["Format HP/MP-Text (1000 = 1k)"] = "设置HP/MP文本格式（1000=1k）",
    ["Gradient Colored HP-Text"] = "渐变显示HP数值",
    ["Text Outlines"] = "描边",
    ["Hide Pet Text"] = "隐藏宠物名",
    ["Statusbars"] = "状态栏",
    ["Flat Textures"] = "FLAT材质",
    ["Player Class Colored Healthbar"] = "玩家生命条职业着色",
    ["NPC Class Colored Healthbar"] = "NPC生命条职业着色",
    ["Castbar"] = "施法条",
    ["Hide Blizz Castbar"] = "隐藏默认施法条",
    ["Castbar Color"] = "普通施法条颜色",
    ["Castbar Channel Color"] = "引导施法条颜色",
    ["Flat Castbar Textures"] = "施法条FLAT材质",
    ["Player Castbar"] = "玩家施法条",
    ["Hide Player Castbar"] = "隐藏玩家施法条",
    ["Player Castbar Above"] = "玩家施法条顶部显示",
    ["Target Castbar"] = "目标施法条",
    ["Hide Target Castbar"] = "隐藏目标施法条",
    ["Target Castbar Above"] = "目标施法条顶部显示",
    ["Nameplates"] = "姓名版",
    ["Debuffs"] = "Debuffs",
    ["Castbars"] = "施法条",
    ["Spell Names"] = "技能名称",
    ...
    ["Flat Health Textures"] = "血条FLAT材质",
    ["Buffs & Debuffs"] = "Buffs & Debuffs",
    ["Show Player Debuffs"] = "显示玩家减益效果",
    ["Debuffs On Top"] = "减益顶部显示",
    ["Show Timers"] = "显示计时",
    ["Cooldowns"] = "冷却计时",
    ["Timer Low Color"] = "计时器基础颜色",
    ["Timer Normal Color"] = "计时器正常颜色",
    ["Timer Minute Color"] = "计时器(分钟)颜色",
    ["Timer Hour Color"] = "计时器(小时)颜色",
    ["Timer Day Color"] = "计时器(天)颜色",
    ["Map"] = "地图设置",
    ["Minimap"] = "小地图设置",
    ...
    ["Hide Clock"] = "隐藏时钟",
    ["Components"] = "组件",
    ["Disable Component"] = "禁用",

    ["Reload UI for changes to take effect."] = "重载界面完成设置",
    ["Reload UI"] = "重载",
    ["Ignore"] = "取消",
    ["Reveal Unexplored Areas"] = "显示未探索区域",
    ["Ctrl+Scroll On Map To Scale"] = "[Ctrl+滚轮] 调整缩放",
    ["Shift+Scroll On Map To Modify Opacity"] = "[Shift+滚轮] 调整透明度",

    --mrbcat addd
    ["Hide Player name"] = "隐藏玩家名字",
    ["Auto Junk"]="关闭自动售卖垃圾",
    ["Auto Repair"]="关闭自动修理",
    ["Clean Up"] = "聊天姓名职业色",
...
zUI_locale = zUI_locale or {}
zUI_locale["zhCN"] = {}

zUI_locale["zhCN"]["class"] = {
...
zUI_locale["zhCN"]["bagtypes"] = {
  ["箭袋"] = "QUIVER",
  ["灵魂袋"] = "SOULBAG",
  ["容器"] = "DEFAULT",
}

zUI_locale["zhCN"]["itemtypes"] = {
  ["INVTYPE_WAND"] = "魔杖",
  ["INVTYPE_THROWN"] = "投掷武器",
  ["INVTYPE_GUN"] = "枪械",
  ["INVTYPE_CROSSBOW"] = "弩",
...
zUI_locale["zhCN"]["hunterpaging"] = {
  ["MELEE"] = "摔绊",
  ["RANGED"] = "奥术射击",
}

zUI_locale["zhCN"]["customcast"] = {
  ["AIMEDSHOT"] = "瞄准射击",
  ["MULTISHOT"] = "多重射击",
  ["STEADYSHOT"] = "稳固射击"
...
zUI_locale["zhCN"]["debuffs"] = {
  ...
  ['寒冰新星'] = { [0] = 2.0, },
  ['寒冰爪'] = { [0] = 6.0, },
  ['寒冰箭'] = { [1] = 5.0, [2] = 6.0, [3] = 6.0, [4] = 7.0, [5] = 7.0, [6] = 8.0, [7] = 8.0, [8] = 9.0, [9] = 9.0,
    [10] = 9.0, [11] = 9.0, [0] = 9.0, },
  ['寒冷抓握'] = { [0] = 5.0, },
  ['导致疯狂'] = { [0] = 6.0, },
  ['尖啸'] = { [0] = 4.0, },
  ...
  ['暴跳如雷'] = { [0] = 2.5, },
  ['暴露伤口效果'] = { [0] = 8.0, },
  ['月火术'] = { [1] = 9.0, [2] = 12.0, [3] = 12.0, [4] = 12.0, [5] = 12.0, [6] = 12.0, [7] = 12.0, [8] = 12.0, [9] = 12.0,
    [10] = 12.0, [0] = 12.0, },
  ['月爪枭兽的灵魂'] = { [0] = 120.0, },
  ['末日降临'] = { [0] = 10.0, },
  ['术士恐惧'] = { [0] = 2.0, },
  ...
  ['火焰节之韧'] = { [0] = 3600.0, },
  ['火焰虚弱'] = { [0] = 45.0, },
  ['火球术'] = { [1] = 4.0, [2] = 6.0, [3] = 6.0, [4] = 8.0, [5] = 8.0, [6] = 8.0, [7] = 8.0, [8] = 8.0, [9] = 8.0,
    [10] = 8.0, [11] = 8.0, [12] = 8.0, [0] = 8.0, },
  ['火药桶爆炸'] = { [0] = 3.0, },
  ['灰尘之云'] = { [0] = 12.0, },
  ['灵质提纯器'] = { [0] = 3.0, },
  ['灵魂凋零'] = { [0] = 1200.0, },
...
zUI_locale["zhCN"]["debuffs"]['冰锥'] = { [0] = 8.0, } -- Cone of Cold

zUI_locale["zhCN"]["totems"] = {
