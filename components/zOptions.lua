...
-------------------------------------------------------------------
	...
	StaticPopupDialogs["CHANGES_RELOAD"] = {
		text = zUI.mlocals["Reload UI for changes to take effect."],
		button1 = zUI.mlocals["Reload UI"],
		button2 = zUI.mlocals["Ignore"],
		OnAccept = function()
	...
	do -- GUI Frame
		...
		zUI.gui.title:SetText("|cffffd200z|c"..color.."UI")
		...
		zUI.gui.version:SetText("|cff555555[|r" .. zUI.version.string.. "|cff555555]|r".." MrBCat汉化增强版M2")
	...
	do -- Generate Config UI
		CreateGUIEntry(zUI.mlocals["About"], nil, function()
			...
			gitlab:SetPoint("TOPLEFT", 120, -225)
			gitlab:SetWidth(100)
			gitlab:SetHeight(20)
			gitlab:SetText("Github-原版")
			gitlab:SetScript("OnClick", function()
				currentURL = "https://github.com/Ko0z/zui"
				StaticPopup_Show("URL_GITLAB_COPY_DIALOG")
			end)
			local gitlab = CreateFrame("Button", nil, this, "UIPanelButtonTemplate")
			gitlab:SetPoint("TOPLEFT", 240, -225)
			gitlab:SetWidth(100)
			gitlab:SetHeight(20)
			gitlab:SetText("Gitee-增强")
			gitlab:SetScript("OnClick", function()
		...
		CreateGUIEntry(zUI.mlocals["General"], nil, function()
			CreateConfig(nil, T[zUI.mlocals["Auto Hide Micro Menu"]], C.global, "microbuttons_auto_hide", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Show Endcaps (Gryphons)"]], C.actionbars, "endcap", "checkbox")
			...
			CreateConfig(nil, T[zUI.mlocals["Auto Dismount"]], C.quality, "auto_dismount", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Auto Stance-Switch"]], C.quality, "auto_stance", "checkbox")
			--mrbcat add 20230713
			--CreateConfig(nil, T[zUI.mlocals["Auto Junk"]], C.quality, "auto_junk", "checkbox")
			...
			-- CreateConfig(nil, T[zUI.mlocals["Swingtimer for all classes"]], C.quality.swingtimer, "enable_for_all", "checkbox")
			-- CreateConfig(nil, T[zUI.mlocals["Swingtimer Color"]], C.swingtimer, "color", "color")
		end)
		CreateGUIEntry(zUI.mlocals["Actionbars"], nil, function()
			CreateConfig(nil, T[zUI.mlocals["Enable BFA-Style"]], C.actionbars, "bfa_style", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Enable Square Style"]], C.actionbars, "squarebuttons", "checkbox")
			
			CreateConfig(nil, T[zUI.mlocals["Hotkey Text Color"]], C.hotkeys, "color", "color")
			CreateConfig(nil, T[zUI.mlocals["Use Blizzard Hotkey Font"]], C.hotkeys, "blizzard_font", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Action Button Border Color"]], C.skin, "dark", "color")
		end)

		CreateGUIEntry(zUI.mlocals["Unitframes"], nil, function()
			CreateConfig(nil, T[zUI.mlocals["Compact Unitframes"]], C.unitframes, "compactmode", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Hide Player name"]], C.unitframes, "Hide_Player_name", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Class Portraits"]], C.unitframes, "classportraits", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Show Status Glow Effect"]], C.unitframes, "statusglow", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Improved Pet Frame"]], C.unitframes, "improvedpet", "checkbox")
			
			CreateConfig(nil, T[zUI.mlocals["Text"]], nil, nil, "header")
			--CreateConfig(nil, T[zUI.mlocals["Force Show Hp/Mp (Ignore 'Status Bar Text' Interface Option)"]], C.unitframes, "forceshowtext", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Show Percentage"]], C.unitframes, "percentages", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Format HP/MP-Text (1000 = 1k)"]], C.unitframes, "trueformat", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Gradient Colored HP-Text"]], C.unitframes, "coloredtext", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Text Outlines"]], C.unitframes, "nameoutline", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Hide Pet Text"]], C.unitframes, "hidepettext", "checkbox")

			CreateConfig(nil, T[zUI.mlocals["Statusbars"]], nil, nil, "header")
			CreateConfig(nil, T[zUI.mlocals["Flat Textures"]], C.unitframes, "healthtexture", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Player Class Colored Healthbar"]], C.unitframes, "playerclasscolor", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["NPC Class Colored Healthbar"]], C.unitframes, "npcclasscolor", "checkbox")
		...
		CreateGUIEntry(zUI.mlocals["Castbar"], nil, function()
			...
			CreateConfig(nil, T[zUI.mlocals["Player Castbar"]], nil, nil, "header")
			CreateConfig(nil, T[zUI.mlocals["Hide Player Castbar"]], C.castbar.player, "hide_zUI", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Player Castbar Above"]], C.castbar.player, "above", "checkbox")

			CreateConfig(nil, T[zUI.mlocals["Target Castbar"]], nil, nil, "header")
			CreateConfig(nil, T[zUI.mlocals["Hide Target Castbar"]], C.castbar.target, "hide_zUI", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Target Castbar Above"]], C.castbar.target, "above", "checkbox")

		end)

		CreateGUIEntry(zUI.mlocals["Nameplates"], nil, function()
			
			CreateConfig(nil, T[zUI.mlocals["Debuffs"]], C.nameplates, "showdebuffs", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Castbars"]], C.nameplates, "showcastbar", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Castbar Color"]], C.nameplates, "castbarcolor", "color")
			CreateConfig(nil, T[zUI.mlocals["Spell Names"]], C.nameplates, "spellname", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Clickthrough"]], C.nameplates, "clickthrough", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Combopoints"]], C.nameplates, "cpdisplay", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Class Colored Friendly Bars"]], C.nameplates, "friendclassc", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Class Colored Hostile Bars"]], C.nameplates, "enemyclassc", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Flat Health Textures"]], C.nameplates, "flat_health_textures", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Flat Castbar Textures"]], C.nameplates, "flat_cast_textures", "checkbox")
		end)

		CreateGUIEntry(zUI.mlocals["Buffs & Debuffs"], nil, function()
			CreateConfig(nil, T[zUI.mlocals["Show Player Debuffs"]], C.aura, "player", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Debuffs On Top"]], C.aura, "above", "checkbox")
			CreateConfig(nil, T[zUI.mlocals["Show Timers"]], C.aura, "timers", "checkbox")
		end)
		
		CreateGUIEntry(zUI.mlocals["Cooldowns"], nil, function()
			CreateConfig(nil, T[zUI.mlocals["Timer Low Color"]], C.appearance.cd, "lowcolor", "color")
			CreateConfig(nil, T[zUI.mlocals["Timer Normal Color"]], C.appearance.cd, "normalcolor", "color")
			CreateConfig(nil, T[zUI.mlocals["Timer Minute Color"]], C.appearance.cd, "minutecolor", "color")
			CreateConfig(nil, T[zUI.mlocals["Timer Hour Color"]], C.appearance.cd, "hourcolor", "color")
		...
		CreateGUIEntry(zUI.mlocals["Map"], nil, function()
			...
			CreateConfig(nil, T[zUI.mlocals["Hide Minimap Button"]], C.minimap, "button_hide", "checkbox")
			--CreateConfig(nil, T[zUI.mlocals["Hide Clock"]], C.minimap, "hide_clock", "checkbox")
		end)
