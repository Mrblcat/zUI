...
------------------------------------------------------
   ...
   if (CanSetFont(CombatTextFont)) then 			CombatTextFont:SetFont(DAMAGE_TEXT_FONT, 24 * CF_SCALE); end
------------------------------------------------------------------------------
...
---------------------------------------------------
   ...
   if (CanSetFont(CombatLogFont)) then 			CombatLogFont:SetFont(DAMAGE_TEXT_FONT, 24 * CF_SCALE); end
